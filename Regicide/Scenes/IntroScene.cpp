...
bool IntroScene::init()
{
    ...
    auto IntroImage = Sprite::create( "LaunchScreenBackground2.png" );
    IntroImage->setPosition( Vec2( sceneOrigin.x + sceneSize.width / 2.f, sceneOrigin.y + sceneSize.height / 2.f ) );
    IntroImage->setContentSize( sceneSize );
